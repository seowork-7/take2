...
const NavLinks = memo(({ className = "" }) => {
  return (
    <div
      className={`w-[744px] relative rounded-13xl bg-gray-300 h-[450px] flex flex-col items-center justify-between p-5 box-border max-w-full max-h-full overflow-auto text-center text-5xl text-text-ui-white-100 font-body-body-2-body-2-regular ${className}`}
    >
